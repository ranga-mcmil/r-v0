...
const mockReferrers = [
  ...
  {
    id: "cust-1", // Added this to match the ID in the URL
    name: "Robert Johnson",
    ...
    notes: "New referrer with high potential",
  },
]

export function ReferrerEditClient({ params }) {
