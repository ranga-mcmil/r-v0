// app/(main)/orders/components/quotation-filters.tsx
"use client"
...
export function QuotationFilters({ currentParams }: QuotationFiltersProps) {
  ...
  const clearFilters = () => {
    router.push('/orders?tab=quotations')
    setIsExpanded(false)
  }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-2">
                <Label htmlFor="orderNumber">Quotation Number</Label>
                <Input
                  id="orderNumber"
                  name="orderNumber"
