      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Provide a price estimate for the customer</p>
          </div>
        </div>
...
// app/(main)/orders/create/immediate-sale/page.tsx - Similar structure
export async function CreateImmediateSalePage() {
  const session = await getServerSession(authOptions)
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Full payment with immediate collection</p>
          </div>
        </div>
